...
const supermarketSchema = new mongoose.Schema<Supermarket>(
    {
        ...
        aisles: [{ type: mongoose.Types.ObjectId, ref: mongo.collectionsNames.aisle, cascade: true }],
        departments: [{ type: mongoose.Types.ObjectId, ref: mongo.collectionsNames.department, cascade: true }],
